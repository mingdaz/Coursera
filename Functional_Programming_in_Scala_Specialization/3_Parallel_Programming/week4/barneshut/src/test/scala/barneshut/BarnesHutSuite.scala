...
//    [Observed Error] 45.0 equaled 45, but 89.0 did not equal 117 minX and maxX are not correctly updated
//    [Lost Points] 2
//
...
//  [Observed Error] Fork(Leaf(0.0,0.0,1.0,List(barneshut.package$Body@35ef1869)),Leaf(2.0,0.0,1.0,List(barneshut.package$Body@c33b74f)),Empty(0.0,2.0,1.0),Empty(2.0,2.0,1.0)) did not equal Fork(Leaf(0.5,0.5,1.0,List(barneshut.package$Body@35ef1869)),Leaf(1.5,0.5,1.0,List(barneshut.package$Body@c33b74f)),Empty(0.5,1.5,1.0),Empty(1.5,1.5,1.0)) expected Fork(Leaf(0.5,0.5,1.0,List(barneshut.package$Body@35ef1869)),Leaf(1.5,0.5,1.0,List(barneshut.package$Body@c33b74f)),Empty(0.5,1.5,1.0),Empty(1.5,1.5,1.0)) found Fork(Leaf(0.0,0.0,1.0,List(barneshut.package$Body@35ef1869)),Leaf(2.0,0.0,1.0,List(barneshut.package$Body@c33b74f)),Empty(0.0,2.0,1.0),Empty(2.0,2.0,1.0))
//  [Lost Points] 2
//
...
//    [Observed Error] ConcBuffer() had size 0 instead of expected size 2 bucket (1,4) should have size 2
//    [Lost Points] 2
//
//  [Test Description] Fork with 3 empty quadrants and 1 leaf (se)
//    [Observed Error] FloatOps.DoubleOps(quad.mass.toDouble).~=(123.0) was false 0.0 should be 123f
//    [Lost Points] 1
//
//  [Test Description] Fork with 4 leaves
//    [Observed Error] FloatOps.DoubleOps(quad.mass.toDouble).~=(263.0) was false 239.5 should be 263f
//    [Lost Points] 2
//
...
//    [Observed Error] res was false Body 1 not found in the right sector in combined sector matrix
//    [Lost Points] 2
//
